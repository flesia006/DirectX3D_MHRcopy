...
void GridScene::MakeMesh()
{
    ...
    vertices.clear();
    //Axis X
    vertices.emplace_back(-MAX_VALUE, 0, 0, 1, 0, 0, 1);
    vertices.emplace_back(+MAX_VALUE, 0, 0, 1, 0, 0, 1);

    //Axis Y
    vertices.emplace_back(0, -MAX_VALUE, 0, 0, 1, 1, 1);
    vertices.emplace_back(0, +MAX_VALUE, 0, 0, 1, 1, 1);

    //Axis Z
    vertices.emplace_back(0, 0, -MAX_VALUE, 0, 0, 1 , 1);
    vertices.emplace_back(0, 0, +MAX_VALUE, 0, 0, 1 , 1);
    ...
    for (int x = -halfW; x <= halfW; x++)
    {
        ...
        vertices.emplace_back(x, 0, -halfH, curGridColor.x, curGridColor.y, curGridColor.z, 1);
        vertices.emplace_back(x, 0, +halfH, curGridColor.x, curGridColor.y, curGridColor.z, 1);
    }
    ...
    for (int z = -halfH; z <= halfH; z++)
    {
        ...
        vertices.emplace_back(-halfW, 0, z, curGridColor.x, curGridColor.y, curGridColor.z, 1);
        vertices.emplace_back(+halfW, 0, z, curGridColor.x, curGridColor.y, curGridColor.z, 1);
    }    
}
